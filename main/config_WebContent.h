...
const char config_webui_body[] = body_header "<fieldset class=\"set1\"><legend><span><b>Configure WebUI</b></span></legend><form method='get' action='wu'><p><b>Units of measurement displayed</b><select id='dm'><option %s value='1'>Metric</option><option %s value='0'>Imperial</option></select></p><p><b>Device naming</b><select id='dn'><option %s value='0'>Model ID</option><option %s value='1'>Device Name</option></select></p><p><b>Secure WebUI</b><input id='sw' type='checkbox' %s></p><br><button name='save' type='submit' class='button bgrn'>Save</button></form></fieldset>" body_footer_config_menu;
