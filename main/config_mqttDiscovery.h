...
#define jsonVersion      "{{ value_json.version | is_defined }}"
#define jsonDC           "{{ value_json.dc | is_defined }}"
#define jsonAC           "{{ value_json.ac | is_defined }}"
#define jsonACFrequency  "{{ value_json.ac_freq | is_defined }}"
#define jsonLight        "{{ value_json.light | is_defined }}"
#define jsonPowerIn      "{{ value_json.power_in | is_defined }}"
#define jsonPowerOut     "{{ value_json.power_out | is_defined }}"
#define jsonMinRemaining "{{ value_json.min_remaining | is_defined }}"
