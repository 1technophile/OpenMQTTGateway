...
/* 
This include must be after the above defines because the previous defines are configuring ArduinoJson and change the namespaces of object used here, 
if the include is before the defines it will not work as expected, becase in link fase some objects will be missing or redefinied.
*/
#include <ArduinoJson.h>

namespace OMG {
typedef JsonObject MQTTMessage;
}